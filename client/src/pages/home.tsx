      ...
      >
        <div className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
          ...
          >
            ...
            <span className="hidden md:inline-block text-lg md:text-xl font-bold px-4 py-2 rounded-xl backdrop-blur-md bg-white/40 border border-white/30 shadow-lg">
              <span className="bg-gradient-to-r from-[#1E3A5F] to-[#0D9488] bg-clip-text text-transparent">Rodas Consulting Group</span>
            </span>
          </div>
          ...
          >
            ...
            <motion.div variants={fadeIn} className="flex items-center justify-center gap-3 text-slate-500">
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-white/50 shadow-sm">
                ...
                <span className="font-medium">Helping businesses work smarter</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <img src={logoImage} alt="RODAS Consulting Group" className="h-60 w-auto object-contain bg-white rounded-lg p-4" />
              </div>
